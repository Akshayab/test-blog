...
get the app created:
    ...
    $ heroku apps:create test-blog
    Creating test-blog... done, stack is cedar
    http://test-blog.herokuapp.com/ | git@heroku.com:test-blog.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://test-blog.herokuapp.com deployed to Heroku

    To git@heroku.com:test-blog.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://test-blog.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@test-blog.herokuapp.com/repl
